...
import { z } from "zod";
import { executeWpApiTool } from "./wp-api-tools.js";
...
function createToolCallback(toolName, context) {
    return async (input) => toToolResult(await executeWpApiTool(toolName, input, context));
}
/** 在 MCP server 上注册 wp-api 的全部工具。 */
export function registerWpApiTools(server, context = {}) {
    server.registerTool("wp_client_list", {
    ...
    server.registerTool("wp_client_add", {
    ...
    server.registerTool("wp_client_use", {
    ...
    server.registerTool("wp_resource_list", {
    ...
    server.registerTool("wp_resource_get", {
    ...
    server.registerTool("wp_resource_create", {
    ...
    server.registerTool("wp_resource_update", {
    ...
    server.registerTool("wp_resource_delete", {
    ...
    server.registerTool("wp_seo_get", {
    ...
    server.registerTool("wp_seo_update", {
    ...
    server.registerTool("wp_post_link_add", {
...
export function createWpApiMcpServer(context = {}) {
...
export async function startStdioServer(context = {}) {
